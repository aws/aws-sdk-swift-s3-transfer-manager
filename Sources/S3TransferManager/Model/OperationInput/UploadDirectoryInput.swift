...
public struct UploadDirectoryInput: TransferInput {
    ...
    ///   - failurePolicy: A closure that handles `uploadObject` operation failures. Default behavior is `DefaultFailurePolicy.rethrowExceptionToTerminateRequest`, which simply bubbles up the error to the caller and terminates the entire `uploadDirectory` operation.
